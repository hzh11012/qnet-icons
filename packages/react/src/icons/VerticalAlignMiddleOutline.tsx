...
const SvgVerticalAlignMiddleOutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="vertical-align-middle-outline_svg__icon"
...
export default SvgVerticalAlignMiddleOutline;
