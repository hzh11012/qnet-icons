...
const SvgRadiusBottomrightOutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="radius-bottomright-outline_svg__icon"
...
export default SvgRadiusBottomrightOutline;
